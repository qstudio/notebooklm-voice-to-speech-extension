...
(function() {
  ...
  // Create a global namespace for our extension (accessible only from this script context)
  const VoiceToTextNLM = {};
...
})(); // Immediately invoke the function to encapsulate the code
